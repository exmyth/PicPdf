 ...
 *
 */
public class BarPic2Pdf_Water2 {
...
//						int mod = index % 36;
						...
						*/
						...
						png1.setAbsolutePosition(leftPos,toPos+69.5f);//leftPos越大,越靠上;toPos越小,越靠左
						png1.scalePercent(scale1);
						png1.setScaleToFitHeight(true);
						document.add(png1);
						
						png2.setAbsolutePosition(leftPos,toPos);//leftPos越大,越靠上;toPos越小,越靠左
						png2.scalePercent(scale2);
						png2.scaleAbsoluteWidth(39.5f);
